...
namespace BBB
{
	public partial class CmdDialog
	{
		...
		protected virtual void Build ()
		{
			...
			// Widget BBB.CmdDialog
			this.Name = "BBB.CmdDialog";
			this.Title = global::Mono.Unix.Catalog.GetString ("Отправка задания");
			this.WindowPosition = ((global::Gtk.WindowPosition)(4));
			// Internal child BBB.CmdDialog.VBox
			...
			w5.Position = 0;
			// Internal child BBB.CmdDialog.ActionArea
